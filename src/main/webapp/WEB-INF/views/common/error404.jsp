...
<head>
    ...
    <title>찾을 수 없는 페이지 입니다.(404)</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
            	<img src="/resources/project/image/Logo/너두있냥.png">
                ...
                <br>
                <img src="/resources/project/image/Logo/logo_text.png">
            </div>
            <footer class="footer text-center w-100">
                © 2024 ItNang Admin by <a href="/">www.itnang.site</a>
            </footer>
        </div>
