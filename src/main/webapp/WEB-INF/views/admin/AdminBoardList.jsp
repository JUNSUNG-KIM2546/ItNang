...
<head>
    ...
    <title>ItNang Admin BoardList</title>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Board List</h3>
					...
					<table class="table table-striped table-hover" border="1">
						...
						<tbody>
							<c:forEach var="boardlist" items="${boardlist}">           
								<tr>
									<th> ${boardlist.boardId} </th>
									<th> ${boardlist.boardSj} </th>
									<th> ${boardlist.uNo} </th>
									<th> <fmt:formatDate value="${boardlist.boardFrst}" pattern="yyyy.MM.dd"/> </th>
									<th> <fmt:formatDate value="${boardlist.boardLast}" pattern="yyyy.MM.dd"/> </th>
									<th> ${boardlist.boardCo} </th>
									<th> <a href="delete/${boardlist.boardId}" class="btn btn-danger btn-sm"> <i class="bi bi-trash"></i> </a> <a href="update/${boardlist.boardId}" class="btn btn-warning btn-sm"> <i class="bi bi-recycle"></i> </a> </th>
								</tr>
							</c:forEach>
						</tbody>
